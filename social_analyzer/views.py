...
def get_sentiment_data(request):
    ...
    def get_sentiment_data_for_keyword(keyword):
    ...
    if compare_keyword1 and compare_keyword2:
        data_comp1 = get_sentiment_data_for_keyword(compare_keyword1)
        data_comp2 = get_sentiment_data_for_keyword(compare_keyword2)
        return JsonResponse({
            'compare1_charts': data_comp1,
            'compare2_charts': data_comp2,
        })
    else:
        chart_data = get_sentiment_data_for_keyword(keyword_filter)
        return JsonResponse({
